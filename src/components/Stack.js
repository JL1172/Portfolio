                    ...
                    <div id="frontDiv">
                        ...
                        <ul className="ul">
                            ...
                            <div className="divUl">
                                <h4>{"<"}Styling{">"}</h4>
                                <div className="relative">
                                    <li><DiBootstrap style={{ color: "rgb(157, 43, 233)" }} /><a target="_blank" href="https://github.com/JL1172/React-Forms">Bootstrap <FiExternalLink /></a></li>
                                </div>
                                <div className="relative">
                                    <li><DiReact style={{ color: "rgb(157, 43, 233)" }} /><a target="_blank" href="https://github.com/JL1172/React-Forms">Reactstrap <FiExternalLink /></a></li>
                                </div>
                                <div className="relative">
                                    <li className="case2"><SiStyledcomponents style={{ color: "rgb(157, 43, 233)" }} /><a target="_blank" href="https://github.com/JL1172/React-Forms">Styled-Components <FiExternalLink /></a></li>
                                </div>
                            ...
                            <div className="divUl">
                                ...
                                <span className="relative">
                                    <li><SiReactrouter style={{ color: "rgb(157, 43, 233)" }} /><a target="_blank" href="https://github.com/JL1172/React-Forms">React-Router <FiExternalLink /></a></li>
                                </span>
                                <span className="relative">
