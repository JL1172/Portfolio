            ...
            {props.loading ?
                ...
                <>
                    <div style={{ padding: "2rem" }}>
                        ...
                        <div id="container">
                            <Typewriter
                                words={["Hi! I am Jacob, welcome to my portfolio. Here is a little bit about me. I am currently a student at Bloom Institute of Technology for Full-stack Web Development, and I am a student at GCU pursuing a Bachelors in Accounting (public-accounting). I love not only the technical expertise software engineering demands, but also the ability to be hands on with a project that can make a difference in the world. I am a team player, highly self-motivated, and driven to exceed expectations. I deliver results. I am passionate about software engineering and development. I enjoy the ever progressing nature of web development. Exceeding customer expectations is a personal priority."]}
                                loop={1}
                                cursor
                                cursorStyle=''
                                typeSpeed={5}
